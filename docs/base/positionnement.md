...
2. [Télécharger les données de référence de la station du RGP la plus proche de sa base](https://github.com/jancelin/docs-centipedeRTK/blob/master/docs/base/positionnement.md#2-t%C3%A9l%C3%A9charger-les-donn%C3%A9es-du-rgp)
